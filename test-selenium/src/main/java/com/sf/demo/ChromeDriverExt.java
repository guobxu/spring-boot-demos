 ...
 */
public class ChromeDriverExt extends ChromeDriver {

    public ChromeDriverExt() throws Exception {
        this(new ChromeOptions());
    }

    public ChromeDriverExt(ChromeOptions options) throws Exception {
        this(ChromeDriverService.createDefaultService(), options);
    }

    public ChromeDriverExt(ChromeDriverService service, ChromeOptions options) throws Exception {
